(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("dyna-ui-field-wrapper"));
	else if(typeof define === 'function' && define.amd)
		define("dyna-ui-input", ["react", "dyna-ui-field-wrapper"], factory);
	else if(typeof exports === 'object')
		exports["dyna-ui-input"] = factory(require("react"), require("dyna-ui-field-wrapper"));
	else
		root["dyna-ui-input"] = factory(root["react"], root["dyna-ui-field-wrapper"]);
...
var DynaInput_1 = __webpack_require__(4);
...
var DynaInput = /** @class */ (function (_super) {
    ...
    DynaInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, style = _a.style, color = _a.color, mode = _a.mode, size = _a.size, label = _a.label, required = _a.required, value = _a.value, inputProps = _a.inputProps, validationMessage = _a.validationMessage, footer = _a.footer;
        return (React.createElement(dyna_ui_field_wrapper_1.DynaFieldWrapper, { className: "dyna-input", mode: mode, style: style, color: color, size: size, inputElementSelector: ".dyna-ui-input-control-element", label: label, required: required, validationMessage: validationMessage, footer: footer },
            React.createElement("input", __assign({ readOnly: mode === dyna_ui_field_wrapper_1.EMode.VIEW, className: "dyna-ui-input-control-element", value: value }, inputProps, { onChange: function (e) { return _this.handleChange(e.target.value); } }))));
    };
...
// module
exports.push([module.i, ".dyna-input .dyna-ui-input-control-element {\n  width: 100%;\n  border: none;\n  font-size: 16px;\n  line-height: 16px;\n  font-weight: bold;\n}\n.dyna-input .dyna-ui-input-control-element:focus {\n  outline: none;\n}\n", ""]);
