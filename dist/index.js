(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("dyna-ui-input", [], factory);
	else if(typeof exports === 'object')
		exports["dyna-ui-input"] = factory();
	else
		root["dyna-ui-input"] = factory();
...
var DynaInput_1 = __webpack_require__(10);
...
var DynaInput = /** @class */ (function (_super) {
    __extends(DynaInput, _super);
    function DynaInput() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.internalId = dyna_guid_1.guid();
        return _this;
    }
    DynaInput.prototype.handleChange = function (value) {
    ...
    DynaInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, style = _a.style, color = _a.color, label = _a.label, value = _a.value, propsForInput = _a.propsForInput, validationMessage = _a.validationMessage, footer = _a.footer;
        var className = [
            'dyna-input',
        ...
        return (React.createElement("div", { className: className, onClick: this.handleContainerClick.bind(this) },
            ...
            React.createElement("div", { className: "dyna-ui-input-container" },
                React.createElement("div", { className: "dyna-ui-input-control-container" },
                    React.createElement("input", __assign({ ref: function (element) { return _this.inputElement = element; }, value: value }, propsForInput, { id: this.internalId, onChange: function (e) { return _this.handleChange(e.target.value); } }))),
                React.createElement("div", { className: "dyna-input-validation-message" }, validationMessage),
                React.createElement("div", { className: "dyna-input-footer" }, footer))));
    };
...
// module
exports.push([module.i, ".dyna-input {\n  outline: none;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  border: 1px solid;\n  border-radius: 4px;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-label {\n  -webkit-box-flex: 1;\n      -ms-flex: 1 0 auto;\n          flex: 1 0 auto;\n  border-right: 1px solid;\n  padding: 8px 16px;\n  font-size: 14px;\n  border-radius: 4px 0 0 4px;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-label label {\n  position: relative;\n  top: 2px;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-input-container {\n  -webkit-box-flex: 1;\n      -ms-flex: 1 1 100%;\n          flex: 1 1 100%;\n  padding: 8px 16px;\n  border-radius: 0 4px 4px 0;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-input-container .dyna-ui-input-control-container {\n  width: 100%;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-input-container .dyna-ui-input-control-container input {\n  border: none;\n  width: 100%;\n  font-size: 16px;\n  font-weight: bold;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-input-container .dyna-ui-input-control-container input:focus {\n  outline: none;\n}\n.dyna-input.dyna-input-style-INLINE_ROUNDED .dyna-ui-input-container .dyna-input-validation-message {\n  font-size: 12px;\n}\n", ""]);
...
// module
exports.push([module.i, ".dyna-input {\n  outline: none;\n}\n.dyna-input.dyna-input-color-WHITE_BLACK {\n  border-color: black;\n  background-color: white;\n}\n.dyna-input.dyna-input-color-WHITE_BLACK .dyna-ui-input-container .dyna-input-validation-message {\n  color: tomato;\n}\n.dyna-input.dyna-input-color-WHITE_RED {\n  border-color: red;\n}\n.dyna-input.dyna-input-color-WHITE_RED .dyna-ui-label {\n  color: white;\n  background-color: red;\n}\n.dyna-input.dyna-input-color-WHITE_RED .dyna-ui-input-container {\n  background-color: white;\n}\n.dyna-input.dyna-input-color-WHITE_RED .dyna-ui-input-container .dyna-input-validation-message {\n  color: tomato;\n}\n.dyna-input.dyna-input-color-BLACK_WHITE {\n  border-color: black;\n}\n.dyna-input.dyna-input-color-BLACK_WHITE .dyna-ui-label {\n  color: white;\n  background-color: black;\n}\n.dyna-input.dyna-input-color-BLACK_WHITE .dyna-ui-input-container {\n  background-color: white;\n}\n.dyna-input.dyna-input-color-BLACK_WHITE .dyna-ui-input-container .dyna-input-validation-message {\n  color: tomato;\n}\n.dyna-input.dyna-input-color-TRANSPARENT_WHITE {\n  border-color: white;\n}\n.dyna-input.dyna-input-color-TRANSPARENT_WHITE .dyna-ui-label {\n  color: white;\n}\n.dyna-input.dyna-input-color-TRANSPARENT_WHITE .dyna-ui-input-container .dyna-ui-input-control-container input {\n  color: white;\n  background-color: transparent;\n}\n.dyna-input.dyna-input-color-TRANSPARENT_WHITE .dyna-ui-input-container .dyna-input-validation-message {\n  color: tomato;\n}\n.dyna-input.dyna-input-color-ORANGE_WHITE {\n  border-color: #eb8a0f;\n}\n.dyna-input.dyna-input-color-ORANGE_WHITE .dyna-ui-label {\n  background-color: #eb8a0f;\n  color: white;\n}\n.dyna-input.dyna-input-color-ORANGE_WHITE .dyna-ui-input-container {\n  background-color: white;\n}\n.dyna-input.dyna-input-color-ORANGE_WHITE .dyna-ui-input-container .dyna-ui-input-control-container input {\n  color: black;\n}\n.dyna-input.dyna-input-color-ORANGE_WHITE .dyna-ui-input-container .dyna-input-validation-message {\n  color: tomato;\n}\n", ""]);
