...
var DynaInput = /** @class */ (function (_super) {
    ...
    DynaInput.prototype.render = function () {
        var _this = this;
        var _a = this.props, style = _a.style, color = _a.color, mode = _a.mode, label = _a.label, required = _a.required, value = _a.value, inputProps = _a.inputProps, validationMessage = _a.validationMessage, footer = _a.footer;
        return (React.createElement(dyna_ui_field_wrapper_1.DynaFieldWrapper, { className: "dyna-input", mode: mode, style: style, color: color, inputElementSelector: ".dyna-ui-input-control-element", label: label, required: required, validationMessage: validationMessage, footer: footer },
